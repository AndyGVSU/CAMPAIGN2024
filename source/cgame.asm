...
@FINWEEK 
	...
	JSR _AICLRPL ;reset surveyed regions
...
_OFFSHIS 
	...
	CMP #$01
	BEQ @WEEK1
	DEC HS_ADDR+1 ;use last week's history, except for week 1
@WEEK1
	LDA #00
	STA HS_ADDR
	RTS 
...
;processes results
_TITLE
	JSR _CLRFAC ;clear float 3 for settings
@SETTING
	JSR _CLRTITLE
	JSR _DRWTITLE
	LDA #$01
