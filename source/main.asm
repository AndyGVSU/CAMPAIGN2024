...
V_FRINGE = $005D+BASE2_4 ;flag FRINGE by player (4B)
V_VBONUSAMT = $0061+BASE2_4 ;CP netted by RALLY BONUS
...
D_AITVADS !hex FF0602010403 ;CTRL table 1 (self/opp/und) ; CTRL table 2
